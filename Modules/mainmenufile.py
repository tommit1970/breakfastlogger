...
def showMenuAdmin():
	...
	print(textJunction)
	textJunction = '{} {} {} - DateStamp - On: {}{}{}'.format(colors.bgRed, main.globals['mainMenu']['dateStampToggle'][0], colors.bgLightGrey,colors.magenta,main.globals['youWantDateStamp'],colors.white)
	print(textJunction)
	textJunction = '{} {} {} - ForcedOnePerDay - On: {}{}{}'.format(colors.bgRed, main.globals['mainMenu']['oneRecPerDayForced'][0], colors.bgLightGrey,colors.magenta,main.globals['oneRecPerDayForced'],colors.white)
	print(textJunction)
	textJunction = '{} {} {} - User Handling'.format(colors.bgRed, main.globals['mainMenu']['viewUsers'][0], colors.bgLightGrey)
	print(textJunction)
